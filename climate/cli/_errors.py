...
Every failure inside climate-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`climate.cli._output`,
...
# Exit-code policy. Documented in ``climate-cli learn`` output.
# 0      = success
